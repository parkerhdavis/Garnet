...
import type { GeometryType, MapKey, NormalType, PreviewPanelHandle } from "@/plugins/texturing/types/pbr";
import { MAP_KEYS } from "@/plugins/texturing/types/pbr";
import { useThreeScene } from "@/plugins/texturing/hooks/useThreeScene";
import { GEOMETRY_OPTIONS, MAP_SLOTS } from "@/plugins/texturing/preview/pbr/constants";
...
const MaterialPreviewPanel = forwardRef<PreviewPanelHandle>(function MaterialPreviewPanel(_props, ref) {
	...
	const sceneConfig = useMemo(() => ({
		...
		customMeshUrl,
	}), [geometry, normalType, normalScale, displacementScale, tilingScale, clayRender, textureDataUrls, customMeshUrl]);
